<?php
$conn = mysqli_connect("localhost","root","","WebFinalProject");
if (!$conn) {
...
$ins5->bind_param("iis",$G_sid,$G_cid,$G_grade);
 /* else{ echo "done";}
  $sql = "create database WebFinalProject";
...
CREATE TABLE Cousrses (
    C_id int(20)  UNSIGNED AUTO_INCREMENT  PRIMARY KEY ,
    C_name varchar(200),
    teacher_id  int(10)
)";
...
CREATE TABLE grades (
    ...
    course_id   int(20)  references Cousrses(id),
    grade varchar(2),
