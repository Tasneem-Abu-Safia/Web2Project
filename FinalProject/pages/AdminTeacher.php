...
<table class="table" id ="teacher">
  ...
  <?php
   ...
   <tr>
     ...
     <td>
     <a href="updateTeacher.php?id=<?php echo $idAdmin;?> & upID=<?php echo $row["id"];?>">
     <button class ="update">Update</button></a>
     <a href="deleteTeacher.php?id=<?php echo $idAdmin;?> & delID=<?php echo $row["id"];?>">
...
<div >
<a href="AddTeacher.php?id=<?php echo $idAdmin?>" style=" margin-left: 53%;">
